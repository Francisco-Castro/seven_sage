defmodule SevenSage.Accounts do
  @moduledoc """
  ...
  alias SevenSage.Accounts.{Student, StudentToken, StudentNotifier}
  ...
  def change_student_registration(%Student{} = student, attrs \\ %{}) do
    Student.registration_changeset(student, attrs, hash_password: false, validate_email: false)
  end
  ...
  def change_student_email(student, attrs \\ %{}) do
    Student.email_changeset(student, attrs, validate_email: false)
  end
  ...
  ## Examples
      ...
      iex> deliver_student_update_email_instructions(student, current_email, &url(~p"/students/settings/confirm_email/#{&1})")
      {:ok, %{to: ..., body: ...}}
  ...
  """
  def delete_student_session_token(token) do
  ...
  ## Examples
      ...
      iex> deliver_student_confirmation_instructions(student, &url(~p"/students/confirm/#{&1}"))
      {:ok, %{to: ..., body: ...}}

      iex> deliver_student_confirmation_instructions(confirmed_student, &url(~p"/students/confirm/#{&1}"))
  ...
  ## Examples
      ...
      iex> deliver_student_reset_password_instructions(student, &url(~p"/students/reset_password/#{&1}"))
      {:ok, %{to: ..., body: ...}}
