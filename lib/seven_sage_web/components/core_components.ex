defmodule SevenSageWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SevenSageWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SevenSageWeb.Gettext, "errors", msg, opts)
    end
  end
